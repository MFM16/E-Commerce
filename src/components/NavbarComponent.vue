    ...
    <navbar class="w-full flex justify-between items-center relative">
        ...
        <div class="flex items-center">
            ...
            <nav id="nav-menu"
                    ...
                    <ul class="flex flex-col py-3 gap-3 lg:flex lg:flex-row lg:gap-5 lg:items-center">
                        <li class="group">
                            <a class="py-2 px-8 text-active group-hover:font-semibold" href="#">Home</a>
                        </li>
                        <li class="group">
                            <a class="py-2 px-8 text-title group-hover:font-semibold" href="#">Categories</a>
                        </li>
                        <li class="group">
                            <a class="py-2 px-8 text-title group-hover:font-semibold" href="#">Sign Up</a>
                        </li>
                        <li class="group">
                            <a class="lg:px-6 lg:pt-1 lg:pb-2 py-2 px-8 text-base text-title lg:bg-primary lg:text-white lg:rounded-md lg:shadow-md group-hover:font-semibold" href="#">
                                Sign In
                            </a>
                        </li>
                        <!-- <li class="group">
                            <div class="px-8 flex flex-row gap-3 items-center">
                                <a class="rounded-full hover:cursor-pointer" href="#">
                                    <img class="object-fill w-10 h-10 rounded-full" src="../assets/img/image13.png" alt="">
                                </a>
                                <span class="text-title">
                                    Hi, User 1
                                </span>
                                <a class="relative hover:cursor-pointer" href="#">
                                    <img class="w-6 h-6" src="../assets/img/cart.png" alt="cart">
                                    <div class="absolute flex justify-center items-center top-1 h-4 w-4 rounded-full -right-2 bg-primary text-white text-xs">
                                        4
                                    </div>
                                </a>
                            </div>
